...
public class SwaggerConfig {
	...
	private ApiInfo getApiInfo() {
		return new ApiInfo("Caliban-API", // NAME
				...
				"<strong>Se sabra si un humano es mutante, si la API encuentra más de una secuencia de cuatro letras iguales​, de forma oblicua, horizontal o vertical.</strong>"+
				"<p>Ejemplos:</p>"+
				"<p><strong>Mutante:</strong> <i>[ \"ATGCGA\",\"CAGTGC\",\"TTATGT\",\"AGAAGG\",\"CCCCTA\",\"TCACTG\" ]</i></p>"+
				"<p><strong>Humano :</strong> <i>[ \"TTGCTA\",\"CAGTGC\",\"TTATGT\",\"AGAAGG\",\"TCCCTA\",\"TCACTG\" ]</i></p>", // DESCRIPTION
				"V. 1.0", // VERSION
